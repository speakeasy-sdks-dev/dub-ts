...
/** @internal */
export const LeadsCountriesCountry$inboundSchema: z.ZodNativeEnum<
  typeof LeadsCountriesCountry
> = z.nativeEnum(LeadsCountriesCountry);

/** @internal */
export const LeadsCountriesCountry$outboundSchema: z.ZodNativeEnum<
  typeof LeadsCountriesCountry
...
/** @internal */
export const LeadsCountries$inboundSchema: z.ZodType<
  LeadsCountries,
  z.ZodTypeDef,
  unknown
> = z.object({

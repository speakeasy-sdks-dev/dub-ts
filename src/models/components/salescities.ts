 ...
 */
export const SalesCitiesCountry = {
  Af: "AF",
  Al: "AL",
  Dz: "DZ",
  As: "AS",
 ...
 * The 2-letter country code of the city: https://d.to/geo
 */
export type SalesCitiesCountry = ClosedEnum<typeof SalesCitiesCountry>;

export type SalesCities = {
  /**
...
/** @internal */
export const SalesCitiesCountry$inboundSchema: z.ZodNativeEnum<
  typeof SalesCitiesCountry
> = z.nativeEnum(SalesCitiesCountry);

/** @internal */
export const SalesCitiesCountry$outboundSchema: z.ZodNativeEnum<
  typeof SalesCitiesCountry
...
/** @internal */
export const SalesCities$inboundSchema: z.ZodType<
  SalesCities,
  z.ZodTypeDef,
  unknown
> = z.object({

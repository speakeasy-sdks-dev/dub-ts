...
/** @internal */
export const LeadsCitiesCountry$inboundSchema: z.ZodNativeEnum<
  typeof LeadsCitiesCountry
> = z.nativeEnum(LeadsCitiesCountry);

/** @internal */
export const LeadsCitiesCountry$outboundSchema: z.ZodNativeEnum<
  typeof LeadsCitiesCountry
...
/** @internal */
export const LeadsCities$inboundSchema: z.ZodType<
  LeadsCities,
  z.ZodTypeDef,
  unknown
> = z.object({

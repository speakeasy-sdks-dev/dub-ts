...
/** @internal */
export const SalesCountriesCountry$inboundSchema: z.ZodNativeEnum<
  typeof SalesCountriesCountry
> = z.nativeEnum(SalesCountriesCountry);

/** @internal */
export const SalesCountriesCountry$outboundSchema: z.ZodNativeEnum<
  typeof SalesCountriesCountry
...
/** @internal */
export const SalesCountries$inboundSchema: z.ZodType<
  SalesCountries,
  z.ZodTypeDef,
  unknown
> = z.object({
